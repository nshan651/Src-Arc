# 0 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/usr/include/stdc-predef.h" 1 3 4
# 0 "<command-line>" 2
# 1 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"



# 1 "/usr/lib/gcc/x86_64-pc-linux-gnu/13.2.1/include/stdbool.h" 1 3 4
# 5 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 2
...
# 6 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 2
...
# 7 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 2
...
# 9 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 2
...
# 10 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 2
...
# 12 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 2
...
# 13 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 2
...
# 14 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 2
...
# 17 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 2
...
# 23 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 2
...
Array mode_style_array(Arena *arena)
{
  ...
  for (int i = 0; i < SHAPE_IDX_COUNT; i++) {
    ...
    Dictionary dic = arena_dict(arena, 3 + ((cur->used_for & 2) ? 9 : 0));
    (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("name"), .value = ((Object) { .type = kObjectTypeString, .data.string = cstr_as_string(cur->full_name) }) })));
    (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("short_name"), .value = ((Object) { .type = kObjectTypeString, .data.string = cstr_as_string(cur->name) }) })));
    if (cur->used_for & 1) {
      (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("mouse_shape"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = cur->mshape }) })));
    }
    if (cur->used_for & 2) {
      String shape_str;
      switch (cur->shape) {
      ...
      (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("cursor_shape"), .value = ((Object) { .type = kObjectTypeString, .data.string = shape_str }) })));
      (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("cell_percentage"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = cur->percentage }) })));
      (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("blinkwait"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = cur->blinkwait }) })));
      (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("blinkon"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = cur->blinkon }) })));
      (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("blinkoff"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = cur->blinkoff }) })));
      (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("hl_id"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = cur->id }) })));
      (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("id_lm"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = cur->id_lm }) })));
      (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("attr_id"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = cur->id ? syn_id2attr(cur->id) : 0 }) })));
      (*((dic).items + ((dic).size++)) = (((KeyValuePair) { .key = cstr_as_string("attr_id_lm"), .value = ((Object) { .type = kObjectTypeInteger, .data.integer = cur->id_lm ? syn_id2attr(cur->id_lm) : 0 }) })));
    }

    (*((all).items + ((all).size++)) = (((Object) { .type = kObjectTypeDictionary, .data.dictionary = dic })));
  }

  return all;
}
# 104 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
char *parse_shape_opt(int what)
{
  ...
  char *slashp;
  char *p = 
# 109 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
           ((void *)0)
# 109 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
               ;
  char *endp;
  int idx = 0;
  int all_idx;
  ...
  int i;
  int found_ve = 
# 115 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                0
# 115 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                     ;
  int round;
  ...
  for (round = 1; round <= 2; round++) {
    if (round == 2 || *p_guicursor == '\000') {
      ...
      if (*p_guicursor == '\000') {
        ui_mode_info_set();
        return 
# 126 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
              ((void *)0)
# 126 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                  ;
      }
    }
    ...
    while (modep != 
# 131 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                   ((void *)0) 
# 131 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                        && *modep != '\000') {
      colonp = vim_strchr(modep, ':');
      commap = vim_strchr(modep, ',');

      if (colonp == 
# 135 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                   ((void *)0) 
# 135 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                        || (commap != 
# 135 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                                      ((void *)0) 
# 135 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                                           && commap < colonp)) {
        return "E545: Missing colon";
      }
      if (colonp == modep) {
        return "E546: Illegal mode";
      }
        ...
        if (all_idx < 0) {
          ...
          if (len == 1 && (((modep[0]) < 'A' || (modep[0]) > 'Z') ? (modep[0]) : (modep[0]) + ('a' - 'A')) == 'a') {
            ...
            if (len == 2 && modep[0] == 'v' && modep[1] == 'e') {
              found_ve = 
# 167 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                        1
# 167 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                            ;
            }
          }
          modep += len + 1;
...
# 199 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                                       0
# 199 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                                            , 0);
              if (len == 3) {
                if (n == 0) {
                  return "E549: Illegal percentage";
                }
                if (round == 2) {
              ...
              endp = vim_strchr(p, '-');
              if (commap == 
# 228 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                           ((void *)0)
# 228 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                               ) {
                if (endp == 
# 229 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                           ((void *)0)
# 229 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                               ) {
                  endp = p + strlen(p);
                }
              } else if (endp > commap || endp == 
# 232 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                                                 ((void *)0)
# 232 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                                                     ) {
                endp = commap;
              }
              slashp = vim_strchr(p, '/');
              if (slashp != 
# 236 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                           ((void *)0) 
# 236 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                                && slashp < endp) {
              ...
              if (round == 2) {
                ...
                if (slashp != 
# 244 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                             ((void *)0) 
# 244 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                                  && slashp < endp) {
      ...
      modep = p;
      if (modep != 
# 258 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
                  ((void *)0) 
# 258 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                       && *modep == ',') {
        modep++;
      }
    }
  ...
  ui_mode_info_set();
  return 
# 281 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
        ((void *)0)
# 281 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
            ;
}
...
# 288 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
_Bool 
# 288 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
...
int cursor_mode_str2int(const char *mode)
{
  ...
  logmsg(3, 
# 307 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
 ((void *)0)
# 307 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
 , __func__, 307, 
# 307 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
 1
# 307 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
...
# 312 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
_Bool 
# 312 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
    cursor_mode_uses_syn_id(int syn_id)
  FUNC_ATTR_PURE
{
  if (*p_guicursor == '\000') {
    return 
# 316 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
          0
# 316 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
               ;
  }
  for (int mode_idx = 0; mode_idx < SHAPE_IDX_COUNT; mode_idx++) {
    if (shape_table[mode_idx].id == syn_id
      ...
      return 
# 321 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
            1
# 321 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
                ;
    }
  }
  return 
# 324 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c" 3 4
        0
# 324 "/home/nick/git/Src-Arc/neovim/src/nvim/cursor_shape.c"
             ;
}
