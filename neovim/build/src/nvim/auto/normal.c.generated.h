...
static _Bool check_text_or_curbuf_locked(oparg_T *oap);
...
static void nv_Zet(cmdarg_T *cap);
static size_t nv_K_getcmd(cmdarg_T *cap, char *kp, _Bool kp_help, _Bool kp_ex, char **ptr_arg, size_t n, char *buf, size_t buf_size);
